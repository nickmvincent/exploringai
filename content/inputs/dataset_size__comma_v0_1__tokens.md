---
title: Raw training tokens (Comma v0.1)
value: 639800000000
scale: 1000000000
...
summary: "Approximate raw-token count across the published Comma v0.1 training stages."
sourceName: "Comma v0.1 training dataset card"
sourceNote: "The dataset card lists 463.6B raw tokens in the main stage and 176.2B raw tokens in the cooldown stage; this input sums both stages."
...
# Raw training tokens (Comma v0.1)

**Value:** 639.8 billions of raw tokens
...
This sums the dataset card's published main-stage and cooldown-stage raw token counts.
