...
variable_name: dataset_size__fineweb2__terabytes
...
This uses the dataset card's rounded corpus-size disclosure rather than a compressed-download estimate.

## Source

- [https://huggingface.co/datasets/HuggingFaceFW/fineweb-2](https://huggingface.co/datasets/HuggingFaceFW/fineweb-2)
- The dataset card describes FineWeb2 as a 20TB corpus.
